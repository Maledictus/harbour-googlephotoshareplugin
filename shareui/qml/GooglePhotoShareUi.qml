        ...
        Column {
            ...
            Column {
                ...
                Column {
                    ...
                    Label {
                        width: settingsList.width - Theme.horizontalPageMargin - googlephotoInfo.x
                ...
                Column {
                    Label {
                        color: Theme.highlightColor
                        //: Destination folder name for GooglePhoto sharing
                        //% "Destination folder"
                    ...
                    Label {
                        ...
                        truncationMode: TruncationMode.Fade
                        font.pixelSize: Theme.fontSizeSmall
                        //: Describes where mobile uploads will go
                        //% "Mobile uploads from Sailfish OS"
                        text: qsTrId("webshare-la-uploads-text")    // TODO: This should come from the share plugin
                    }
                }
            }
        }
